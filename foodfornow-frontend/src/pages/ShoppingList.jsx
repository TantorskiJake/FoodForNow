...
const pickPreferredUnit = (units, family) => {
  if (family === 'volume') {
    // Prefer larger, kitchen-friendly units when available
  ...
  if (family === 'weight') {
    // Prefer grams, then kilograms, then imperial
